                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group ">
                                <label for="title" class="col-form-label pt-0">Sub Category</label>
                                <div class="">
                                    <input class="form-control" type="text" required name="title" value="{{ old('title', isset($subcategory->title) ? $subcategory->title : '') }}" placeholder="Enter Your Name">
                                </div>
                            </div>
        ...
        <div class="card" >
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group d-flex">
                            ...
                            <input type="checkbox" id="switch1" switch="none" name="status" {{ old('status', isset($subcategory->status) ? $subcategory->status : '')=='active' ? 'checked':'' }}/>
                ...
                <div class="row mt-2 justify-content-center">
                    <div class="form-group">
                        <div>
                            <a class="btn btn-light waves-effect ml-1" href="{{ route('subcategory.index') }}">
